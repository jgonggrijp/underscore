(function (global, factory) {
  ...
  var extendOwn = createAssigner(_keys);
  ...
  var isArray = nativeIsArray || typeTester('Array');
  ...
  var isArguments = typeTester('Arguments');
  ...
  var isMap = typeTester('Map');
  var isWeakMap = typeTester('WeakMap');
  var isSet = typeTester('Set');
  var isWeakSet = typeTester('WeakSet');
  ...
  var underscoreModule = mixin(allExports);

  return underscoreModule;
